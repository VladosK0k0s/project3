...
const AboutUs = () =>{
	return(
		<div id='aboutus' className='AboutUs'>
			...
			<p>
				<p>Ви зможете <b>абсолютно законно не платити штраф</b> і не допустити, щоб з вас здирали гроші. 
				...
				<p>Ціна на наші послуги символічна, бо ми прагнемо допомогти кожному водію, без фінансових втрат. 
				...
				<p>Тепер ви можете скористатись нашими послугами. 
