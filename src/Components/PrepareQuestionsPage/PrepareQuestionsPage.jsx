      ...
      stepsArr: [
        {
          ...
          text: (
            <p>
              ...
              Звертаю увагу, що оскарження автоштрафу здійснюється виключно
              протягом 10 днів з дати вручення такої постанови
            </p>
          ),
        ...
        {
          id: 2,
          text: "За допомогою якого пристрою було зафіксоване порушення ПДР?",
          component: <DevicePicker handleChoose={this.handleChoose} />,
          nextYesId: 4,
          nextNoId: 5,
        },
        {
  ...
  handleChoose = (status, obj) => {
    ...
    if (status === "yes") {
      if (curQuestion.argumentYes) {
        this.setState({
          sendObj: Object.assign(this.state.sendObj, curQuestion.argumentYes),
        });
      }
      ...
      if (curQuestion.argumentNo) {
        this.setState({
          sendObj: Object.assign(this.state.sendObj, curQuestion.argumentNo),
        });
      }
          ...
          <div className="QuestionBlock">
            ...
            {curQuestion.component ? (
              ...
              <div className={"AnswerBlock"}>
                ...
                >
                  {curQuestion.yesText ? curQuestion.yesText : "Так"}
                </button>
                <button
                  onClick={() => {
                ...
                >
                  {curQuestion.noText ? curQuestion.noText : "Ні"}
                </button>
                <button
                  onClick={() => {
                    this.handleGetBack();
          ...
          <Modal.Body className="modaaaal2">
            <div className="items">
              <div>
                <img src={arrow1} alt="" />
                <p>
                  Просимо Вас бути уважними під час заповнення даних необхідних
                  для формування позову.
                </p>
              </div>
              <div>
                <img src={arrow1} alt="" />
                <p>
                  Якщо Ви вже оплатили цей штраф, то наші послуги не є для Вас
                  актуальними.
                </p>
              </div>
              <div>
                <img src={arrow1} alt="" />
                <p>
                  Ми не несемо відповідальності у разі постановлення ухвали суду
                  не на Вашу користь.
                </p>
              </div>
              <div>
                <img src={arrow1} alt="" />
                <p>
                  Ця форма використовується лише для генерації тексту позовної
                  заяви. Ми не збираємо і не зберігаємо інформацію, яку ви
                  вводите.
                </p>
              </div>
              <div className="checkbox">
                ...
                <p>
                  Погоджуюсь з{" "}
                  <NavLink to="/offer">умовами Публічної оферти</NavLink> та{" "}
                  <NavLink to="/policy">
